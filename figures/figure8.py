...
cax = fig.add_axes([0.15, 0.97, 0.7, 0.02])  # Adjust position and size as needed
...
cbar.set_label('$\overline{P}_{Ca}$ (nL/s)', labelpad = 0)

plt.subplots_adjust(top=0.82, right=0.88, wspace=0.30)
plt.show()
plt.close()
